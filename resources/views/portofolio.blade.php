...
@section('content')
    ...
    <body class="w3-light-grey w3-content" style="max-width:1600px">
        ...
        <nav class="w3-sidebar w3-bar-block w3-white w3-animate-left w3-text-grey w3-collapse w3-top w3-center"
            ...
            <h3 class="w3-padding-64 w3-center"><b>hey,<br>hello there?</b></h3>
            <a href="javascript:void(0)" onclick="w3_close()"
                class="w3-bar-item w3-button w3-padding w3-hide-large">CLOSE</a>
            <a href="#" onclick="w3_close()" class="w3-bar-item w3-button">You</a>
            <a href="#about" onclick="w3_close()" class="w3-bar-item w3-button">Me</a>
        ...
        <div class="w3-main" style="margin-left:300px">
            ...
            <div class="w3-row">
                <div class="w3-third">
                    <img src="/w3images/natureboy.jpg" style="width:100%" onclick="onClick(this)"
                        alt="A boy surrounded by beautiful nature">
                    <img src="/w3images/girl_mountain.jpg" style="width:100%" onclick="onClick(this)"
                ...
                <div class="w3-third">
                    ...
                    <img src="/w3images/man_bench.jpg" style="width:100%" onclick="onClick(this)"
            ...
            <div class="w3-container w3-dark-grey w3-center w3-text-light-grey w3-padding-32" id="about">
                <h4><b>About Me</b></h4>
                <img src="/w3images/avatar_hat.jpg" alt="Me" class="w3-image w3-padding-32" width="600"
                    height="650">
